...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.documents_uploaded_by = await users.getDocuments_uploaded_by({
      transaction,
    });

    output.emails_sent_by = await users.getEmails_sent_by({
      transaction,
    });
    ...
    output.tasks_assigned_user = await users.getTasks_assigned_user({
      transaction,
    });
