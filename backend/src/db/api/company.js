...
module.exports = class CompanyDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.emails_company = await company.getEmails_company({
      transaction,
    });

    output.notifications_company = await company.getNotifications_company({
      transaction,
    });

    output.reports_company = await company.getReports_company({
      transaction,
    });

    output.tasks_company = await company.getTasks_company({
      transaction,
    });
